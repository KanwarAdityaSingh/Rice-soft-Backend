...
import saudaWeightVarianceRoutes from './sauda-weight-variance.routes';
...
import packagingMaterialRoutes from './packaging-material.routes';
import packagingMaterialPurchaseRoutes from './packaging-material-purchase.routes';
...
import couponAllotmentRoutes from './coupon-allotment.routes';
...
router.use('/sauda-weight-variances', saudaWeightVarianceRoutes);
router.use('/recipes', recipeRoutes);
router.use('/products', productRoutes);
router.use('/packaging', packagingRoutes);
router.use('/packaging-vendors', packagingVendorRoutes);
router.use('/master-vendors', packagingVendorRoutes);
router.use('/brands', brandRoutes);
router.use('/packaging-materials', packagingMaterialRoutes);
router.use('/packaging-material-purchases', packagingMaterialPurchaseRoutes);
...
router.use('/coupons/admin', couponAllotmentRoutes);
router.use('/coupons/public', couponPublicRoutes);
router.use('/public/invoice-dispatches', invoiceDispatchPublicRoutes);
