...
export const REDEMPTION_PAID_VIA = ['manual', 'razorpay'] as const;
...
export const RAZORPAY_WEBHOOK_STATUSES = ['received', 'processed', 'ignored', 'failed'] as const;

export type RazorpayWebhookStatus = (typeof RAZORPAY_WEBHOOK_STATUSES)[number];
