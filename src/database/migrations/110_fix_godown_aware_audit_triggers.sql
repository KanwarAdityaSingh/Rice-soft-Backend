-- Migration 110
-- Purpose: Make legacy audit trigger functions godown-aware after inventory segmentation.
-- Affects:
--   1) initialize_lot_inventory_with_audit()
--   2) update_bags_inventory_on_kaanta_create_with_audit()
...
BEGIN
    ...
    -- Get current filled_bags count for this godown + bag tuple
